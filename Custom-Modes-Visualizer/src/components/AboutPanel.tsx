      ...
      >
        ...
        <div className="p-4 pt-9">
           ...
           <div className="mb-6">
             ...
             <div className="text-sm text-slate-600 space-y-2 mb-4">
              ...
              <a
                ...
                className="block mx-auto bg-purple-500 text-white px-6 py-2.5 rounded-full font-semibold text-center text-base hover:bg-purple-600 transition-colors duration-200 mb-4"
              >
                Contribute!
              </a>
            <p>
          ...
          <div className="flex justify-center space-x-4">
            ...
            <a
              href="https://ko-fi.com/jamescherished"
              target="_blank"
              rel="noopener noreferrer"
              className="w-12 h-12 bg-white bg-opacity-20 rounded-full flex items-center justify-center hover:bg-opacity-30 transition-all duration-200 hover:scale-110"
